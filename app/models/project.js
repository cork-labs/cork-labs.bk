...
/**
 * validation / path / required owner
 */
ProjectSchema.path('path').required(true, 'required');
...
ProjectSchema.statics = {
     ...
     * @param {function} cb
     */
     create: function (id, status, name, path, repo, cb) {
     ...
     * @param {function} cb
     */
    addVersion: function (id, version, docsUrl, cb) {
